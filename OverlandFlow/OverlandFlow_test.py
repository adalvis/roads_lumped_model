...
#initialize values for q calculations
elapsed_time = 0.0
...
while elapsed_time < model_run_time:
    ...
    rmg.at_node['surface_water__discharge'] = (map_max_of_inlinks_to_node(rmg,
               np.abs(of.q)*rmg.dx))
...
#re-initialize to get water depth map at t = 2hr
elapsed_time = 0.0
hydrograph_time = []
discharge_at_outlet = []
...
imshow_grid(rmg, 'surface_water__depth', plot_name 
            = 'Water depth at time = 2 hr', var_name = 'Water depth', 
